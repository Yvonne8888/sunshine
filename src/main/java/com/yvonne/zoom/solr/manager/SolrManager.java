package com.yvonne.zoom.solr.manager;
...
public class SolrManager {
    ...
    public void queryIndex1() throws SolrServerException, IOException {
        ...
        //设置查询条件，相当于：params.set("q", "*:*");
        params.setQuery("*:*");
        //过滤查询
        params.set("fq", "product_catalog_name:幽默杂货");
        //排序
    ...
    public void queryIndex2() throws SolrServerException, IOException {
        SolrQuery params = new SolrQuery();
        //相当于：params.setQuery("钻石");
        params.set("q", "钻石");
        //相当于：params.setFilterQueries("product_catalog_name:幽默杂货");
        params.set("fq", "product_catalog_name:幽默杂货");
        //相当于：params.set("sort", "product_price");
